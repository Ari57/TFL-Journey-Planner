...
class TestInput(unittest.TestCase):
    ...
    # assuming the user passed in something like an int or boolean, we raise a TypeError as an example
        ...
        startingLocation() # what happens if a TypeError is raised, the function runs fine, but there are no startingLocation values to choose from
    ...
    def test_ValidLetter(self):
        ...
        startingLocation() # same as above, no values are given to the startingLocation function
